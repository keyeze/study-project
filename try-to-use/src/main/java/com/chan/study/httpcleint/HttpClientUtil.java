...
public class HttpClientUtil {
    ...
    private final Map<String, String> DEFAULT_HEADER_MAP;
    ...
    public static <T> T get(String url, Class<T> clazz) {
        return httpClientServiceOpt.map(item -> item.get(url, null, null, clazz)).orElseThrow(rejectStrategy);
    }
    ...
    public static <T> T post(String url, String body, Class<T> clazz) {
        return httpClientServiceOpt.map(item -> item.post(url, null, null, body, clazz)).orElseThrow(rejectStrategy);
    }
    ...
    public static <Resp> Resp post(String url, Map<String, String> params, Class<Resp> clazz) {
        return httpClientServiceOpt.map(item -> item.post(url, null, null, params, clazz)).orElseThrow(rejectStrategy);
    }
